    ...
    <div id='about' className={styles.container}>
        ...
        <div className={styles.section}>
              ...
              transition={{ duration: 0.7, ease: "easeOut", delay: 0.1}} className={styles.infoSectionOne}>
                    ...
                    initial={{opacity: 0 , y: 100}}
                  animate={isInView ? { opacity: 1, y: 0 }: {opacity: 0, y: 100}}
                 transition={{ duration: 0.9, ease: "easeOut", delay: 0.2}}  className={styles.headingName}>My Name is <span >Manu Rajbhar</span> but you can call me <span >MR 😄</span></motion.h1>
                        <motion.div  
               initial={{opacity: 0 , y: 100}}
               animate={isInView ? { opacity: 1, y: 0 }: {opacity: 0, y: 100}}
